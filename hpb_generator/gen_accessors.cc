...
void WriteMapFieldAccessors(const google::protobuf::Descriptor* desc,
  ...
  if (val->cpp_type() == google::protobuf::FieldDescriptor::CPPTYPE_MESSAGE) {
    ctx.Emit(
        {Sub("set_field_name_const", absl::StrCat("set_", resolved_field_name))
             .AnnotatedAs({field, io::AnnotationCollector::kSet}),
         Sub("set_field_name_mut", absl::StrCat("set_", resolved_field_name))
             .AnnotatedAs({field, io::AnnotationCollector::kSet}),
         Sub("set_alias_field_name_const",
             absl::StrCat("set_alias_", resolved_field_name))
             .AnnotatedAs({field, io::AnnotationCollector::kSet}),
         Sub("set_alias_field_name_mut",
             absl::StrCat("set_alias_", resolved_field_name))
             .AnnotatedAs({field, io::AnnotationCollector::kSet}),
        ...
        R"cc(
          bool $set_field_name_const$($const_key$ key, $ConstPtr$ value);
          bool $set_field_name_mut$($const_key$ key, $MutPtr$ value);
          bool $set_alias_field_name_const$($const_key$ key, $ConstPtr$ value);
          bool $set_alias_field_name_mut$($const_key$ key, $MutPtr$ value);
